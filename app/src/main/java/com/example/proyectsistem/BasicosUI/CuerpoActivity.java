...
public class CuerpoActivity extends AppCompatActivity {
    ...
    ImageButton btnojo,btnpie,btnnat1,btnnat2;
    public MediaPlayer ojo_aud,pie_aud;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Titulo
        this.setTitle("El Cuerpo Humano");
        //Imagen Icono
    ...
    private void setupview() {
        //ojo
        btnojo=findViewById(R.id.btn_ojo);
        ojo_aud=MediaPlayer.create(this,R.raw.ojo);
        ...
        pie_aud=MediaPlayer.create(this,R.raw.pie);
        ...
        //anu_aud
        btnnat1=findViewById(R.id.btn_cuer2);
        ...
        //anu_califica
        califica_aud1=findViewById(R.id.calificar_aud_cuer1);
        //ispi_aud
        btnnat2=findViewById(R.id.btn_cuer1);
        ...
        //ispi_califica
        califica_aud2=findViewById(R.id.calificar_aud_cuer2);

        //Editext
        califica_txt1=findViewById(R.id.califica_txt_cuer1);
        califica_txt2=findViewById(R.id.califica_txt_cuer2);
        califica_txt3=findViewById(R.id.califica_txt_cuer3);
        ...
        Calificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(CalificarVocales()){
                    Toast.makeText(CuerpoActivity.this, "Tema concluido con exito, Nuevo Tema desbloqueado", Toast.LENGTH_SHORT).show();
                    PuntajeBasico puntajeBasico= PuntajeBasico.findxUser(usuarior,19);
                    puntajeBasico.Puntaje=100;
                    puntajeBasico.save();
                }else {
                    Toast.makeText(CuerpoActivity.this, "revise las pruebas puede que algunas esten incorrectas", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private boolean CalificarVocales() {
        if(califica_aud1.getText().toString().equals("Correcto")){
            if (califica_aud2.getText().toString().equals("Correcto")){
                    if(califica_txt1.getText().toString().equals("kuns sañss muni ampara")){
                        if(califica_txt2.getText().toString().equals("como se dice oreja")){
                            if(califica_txt3.getText().toString().equals("kuns sañss muni puraka")){
                                return true;
                            }else {return false;}
                        }else {return false;}
                    }else {return false;}
