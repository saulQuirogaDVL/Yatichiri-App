...
public class ArbolActivity extends AppCompatActivity {
    ...
    private void setupview() {
        //anu_aud
        btnnat1=findViewById(R.id.btn_arb1);
        ...
        //anu_califica
        califica_aud1=findViewById(R.id.calificar_aud_arb1);
        //ispi_aud
        btnnat2=findViewById(R.id.btn_arb2);
        ...
        //ispi_califica
        califica_aud2=findViewById(R.id.calificar_aud_arb2);

        //ispi_aud
        btnnat3=findViewById(R.id.btn_arb3);
        ...
        //ispi
        califica_aud3=findViewById(R.id.calificar_aud_arb3);

        //Editext
        califica_txt1=findViewById(R.id.califica_txt_arb1);
        califica_txt2=findViewById(R.id.califica_txt_arb3);
        califica_txt3=findViewById(R.id.califica_txt_arb2);
        ...
        Calificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(CalificarVocales()){
                    Toast.makeText(ArbolActivity.this, "Tema concluido con exito, Nuevo Tema desbloqueado", Toast.LENGTH_SHORT).show();
                    PuntajeBasico puntajeBasico= PuntajeBasico.findxUser(usuarior,16);
                    puntajeBasico.Puntaje=100;
                    puntajeBasico.save();
                }else {
                    Toast.makeText(ArbolActivity.this, "revise las pruebas puede que algunas esten incorrectas", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
