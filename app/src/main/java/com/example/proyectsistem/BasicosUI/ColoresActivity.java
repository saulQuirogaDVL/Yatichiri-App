...
public class ColoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_colores);//Titulo
    ...
    private void setupview() {
        //anu_aud
        btnnat1=findViewById(R.id.btn_col1);
        ...
        //anu_califica
        califica_aud1=findViewById(R.id.califica_aud_col1);
        //ispi_aud
        btnnat2=findViewById(R.id.btn_col2);
        ...
        //ispi_califica
        califica_aud2=findViewById(R.id.califica_aud_col2);

        //ispi_aud
        btnnat3=findViewById(R.id.btn_col3);
        ...
        //ispi
        califica_aud3=findViewById(R.id.califica_aud_col3);

        //Editext
        califica_txt1=findViewById(R.id.califica_txt_col1);
        califica_txt2=findViewById(R.id.califica_txt_col2);
        califica_txt3=findViewById(R.id.califica_txt_col3);
        ...
        Calificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(CalificarVocales()){
                    Toast.makeText(ColoresActivity.this, "Tema concluido con exito, Nuevo Tema desbloqueado", Toast.LENGTH_SHORT).show();
                    PuntajeBasico puntajeBasico= PuntajeBasico.findxUser(usuarior,17);
                    puntajeBasico.Puntaje=100;
                    puntajeBasico.save();
                }else {
                    Toast.makeText(ColoresActivity.this, "revise las pruebas puede que algunas esten incorrectas", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        if(califica_aud1.getText().toString().equals("Correcto")){
            if (califica_aud2.getText().toString().equals("Correcto")){
                if(califica_aud3.getText().toString().equals("Correcto")){
                    if(califica_txt1.getText().toString().equals("uqi")){
                        if(califica_txt2.getText().toString().equals("larama")){
                            if(califica_txt3.getText().toString().equals("wila")){
                                return true;
                            }else {return false;}
                        }else {return false;}
                    }else {return false;}
